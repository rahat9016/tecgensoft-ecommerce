        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-6 xl:grid-cols-8 gap-4">
            {electronicsInventory.map((item) => (
              <div
                key={item?.id}
                className="bg-white rounded-xl flex flex-col items-center justify-center px-2 py-2 min-h-[134px] gap-3 group cursor-pointer"
              >
...
export default FeaturedCategoryBig;
