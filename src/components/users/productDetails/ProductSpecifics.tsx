...
const ProductSpecifics = () => {
  ...
  return (
    <div className="h-full flex flex-col md:flex-row lg:flex-col xl:flex-row xl:w-[calc(100%-350px)] gap-3">
            ...
            <div className="w-full flex flex-col gap-3 lg:gap-4">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex items-center gap-8">
                  ...
                  >
                    ...
                    {/*  */}
                    <div className="w-[43px] pl-3 lg:pl-3.5 h-[30px] bg-white flex items-center justify-center rounded-5px text-xs font-semibold">
                      <input
              ...
              `}
                ...
                <p className="text-spanish-gray text-xs font-medium hidden lg:flex items-center gap-2">
                  <IoIosCheckmarkCircle className="text-lg text-[#4CAF50]" />{" "}
      ...
      <div className="flex-shrink-0 md:w-[330px] lg:w-full xl:w-[330px] bg-slate-600">
        delivery details part Lorem, ipsum dolor sit amet consectetur
        adipisicing elit. Ipsum temporibus pariatur dolorum placeat nemo tempora
        id minima adipisci tenetur rem! Eius, nihil quae nisi maiores
        necessitatibus vel nemo consequatur illum facere, rerum deleniti
        pariatur, sed dolorum cupiditate sunt? Temporibus, velit rerum mollitia
        aspernatur dicta nisi, voluptatem ipsa quo harum excepturi assumenda
        culpa obcaecati, minus quibusdam.
      </div>
    </div>
  );
};
